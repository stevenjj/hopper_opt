#ifndef HOPPER_ACT_ACTIVE_CONTACT_KINEMATIC_CONSTRAINT_H
#define HOPPER_ACT_ACTIVE_CONTACT_KINEMATIC_CONSTRAINT_H
...
class Hopper_Act_Active_Contact_Kinematic_Constraint: public Constraint_Function{
public:
	Hopper_Act_Active_Contact_Kinematic_Constraint(int knotpoint_in, Contact_List* contact_list_obj_in, int contact_index_in);	
	~Hopper_Act_Active_Contact_Kinematic_Constraint();
