#ifndef HOPPER_POS_1D_KINEMATIC_CONSTRAINT_H
#define HOPPER_POS_1D_KINEMATIC_CONSTRAINT_H
...
class Hopper_Position_Kinematic_Constraint: public Constraint_Function{
public:
	Hopper_Position_Kinematic_Constraint(int knotpoint_in, int link_id_in, int dim_in, double l_bound_in, double u_bound_in);	
	Hopper_Position_Kinematic_Constraint(int link_id_in, int dim_in, double l_bound_in, double u_bound_in);
	~Hopper_Position_Kinematic_Constraint();
